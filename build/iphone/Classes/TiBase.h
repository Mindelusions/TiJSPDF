...
// in simulator we redefine to format for JSPDF Developer console
...
{\
	NSString * exceptionName = [@"org.jspdf." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.jspdf";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIJSPDFNativeItemNone = -1, 
	UIJSPDFNativeItemSpinner = -2,
	UIJSPDFNativeItemProgressBar = -3,
	
	UIJSPDFNativeItemSlider = -4,
	UIJSPDFNativeItemSwitch = -5,
	UIJSPDFNativeItemMultiButton = -6,
	UIJSPDFNativeItemSegmented = -7,
	
	UIJSPDFNativeItemTextView = -8,
	UIJSPDFNativeItemTextField = -9,
	UIJSPDFNativeItemSearchBar = -10,
	
	UIJSPDFNativeItemPicker = -11,
	UIJSPDFNativeItemDatePicker = -12,
	
	UIJSPDFNativeItemInfoLight = -13,
	UIJSPDFNativeItemInfoDark = -14,
	
	UIJSPDFNativeItemDisclosure = -15,
	
	UIJSPDFNativeItemContactAdd = -16
};
